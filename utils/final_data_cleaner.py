...
def main():
    ...
    try:
        # 文件路径
        input_file = Path("raw_datasets/commonsense/cs_all.jsonl")
        output_file = Path("raw_datasets/commonsense/cs_all_final.jsonl")
        sample_file = Path("raw_datasets/commonsense/cs_all_final_sample.jsonl")
        ...
        with open(input_file, 'r', encoding='utf-8') as f_in, \
            ...
            for line_num, line in enumerate(f_in, 1):
                ...
                if processed_count < 20:
                    f_sample.write(json.dumps(cleaned_sample, ensure_ascii=False, indent=2) + '\n')
